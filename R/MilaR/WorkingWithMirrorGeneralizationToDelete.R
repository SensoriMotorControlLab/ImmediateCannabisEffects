...
## need additional changes to filenames
# change mirrorgenearlization
...
source('R/mirrorgeneralizationhor.R')

nlines <- c(143)

year <- "pavlovia"
semester <- "2023-07"
task <- "mirrorgeneralizationhor"
...
test <- mirrorgeneralizationhor(participants$filename[1])
